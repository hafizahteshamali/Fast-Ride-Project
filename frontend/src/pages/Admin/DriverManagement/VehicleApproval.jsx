          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4 modal-content-enter">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200">
              <div className="text-center p-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Approve Vehicle</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Are you sure you want to approve this vehicle for <span className="font-bold text-green-700">{selectedVehicle.driverName}</span>? 
